...
// mydocument.cpp : implementation of the mydocument class
//
...
// mydocument construction/destruction

mydocument::mydocument() noexcept
{
...
void mydocument::OnDrawThumbnail(CDC& dc, LPRECT lprcBounds)
{
...
void mydocument::InitializeSearchContent()
{
...
void mydocument::SetSearchContent(const CString& value)
{
	if (value.IsEmpty())
	{
